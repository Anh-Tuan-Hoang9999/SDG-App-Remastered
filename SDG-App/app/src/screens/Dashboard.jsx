                ...
                <Link to={section.path} className="block group">
                  ...
                  >
                    <div
                      ...
                      style={{
                        background: isDark
                          ? 'linear-gradient(135deg, rgba(94,200,138,0.18) 0%, rgba(87,180,216,0.14) 100%)'
                          : 'var(--app-muted)',
                        boxShadow: isDark ? 'inset 0 0 0 1px rgba(94,200,138,0.16)' : 'none',
                      }}
                    >
                      <Icon className="w-5 h-5" style={{ color: isDark ? 'var(--app-accent, #5EC88A)' : '#4A8A70' }} />
                    </div>
                    <div className="flex items-start justify-between gap-2 mb-1.5">
                      ...
                      <ArrowRight
                        ...
                        style={{ color: isDark ? 'var(--app-accent-2, #57B4D8)' : '#4A8A70' }}
                      />
                    </div>
